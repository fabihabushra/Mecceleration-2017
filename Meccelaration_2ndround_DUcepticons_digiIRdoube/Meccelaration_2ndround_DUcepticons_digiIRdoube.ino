...
int contiWhite=10025,stopCounter=0,allWhite=1,lastBoxDelay=500;
...
*/
  ...
  if(stopCounter>contiWhite)
  {
    curveWallKey=1;
  }
  if(endKey==1 && allWhite==1)
  {
    plannedCRotate();
    delay(lastBoxDelay);
  }
...
digitalWrite(buzzer,LOW);
 ...
 if(mappedValue!=111)
  ...
  {  
      if(curveWallKey==1 && digitalRead(lIR))
      {
